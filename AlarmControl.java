...
public class AlarmControl extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        address = intent.getStringExtra(MainActivity.EXTRA_ADRESS);
        ...
        new AlarmControl.ConnectBT().execute();
    ...
    private class ConnectBT extends AsyncTask<Void, Void, Void> {
        ...
        protected  void onPreExecute () {
            progress = ProgressDialog.show(AlarmControl.this, "Connecting...", "Please Wait!!!");
        }
